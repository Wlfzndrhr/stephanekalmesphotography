...
function publishStory() {
  FB.ui({
    ...
    link: 'http://stephanekalmesphotography.herokuapp.com/',
    picture: 'http://stephanekalmesphotography.herokuapp.com/ img/facebook_icon_large.png',
    actions: [{ name: 'Get Started', link: 'http://stephanekalmesphotography.herokuapp.com/' }],
  }, 
  function(response) {
